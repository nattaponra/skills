...
| **Tests** | Unit tests for all changed code; meaningful assertions; E2E green |
...
5. Approve only when all must-fix items are resolved and E2E passed.
...
- Do not approve while E2E is failing, docs are stale/missing, or the CHANGELOG entry is absent.
